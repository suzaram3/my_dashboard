"""initial_db_ migration

Revision ID: 33bd172d87c0
Revises: 
Create Date: 2022-02-22 10:44:16.741643
...
def upgrade():
    ...
    sa.Column('last_contact', sa.String(length=10), nullable=True),
    sa.Column('next_contact', sa.String(length=10), nullable=True),
